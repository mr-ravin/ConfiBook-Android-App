...
const OverallScreen = ({navigation, route}: OverallScreenProps) => {
    const {ScreenMode, AppPassword, Id, Title, Notes} = route.params
    ...
    const storage_file_data_path = RNFS.DocumentDirectoryPath+'/CBData.json';
         ...
         renderItem={({item})=>
            ...
            <View style={styles.PairElements}>
                ...
                <MenuDivider/>
                    ...
                    /><Text style={styles.MenuTextColor}>  Delete</Text></MenuItem>
                    <MenuDivider/>
