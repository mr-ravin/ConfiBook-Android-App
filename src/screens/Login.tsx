...
const LoginScreen = ({navigation}: LoginProps) => {
    const storage_file_path = RNFS.DocumentDirectoryPath+'/CBKey.json';
    ...
    <View style={styles. ButtonInputPair}>
     <TextInput style={styles.PasswordInput}
      ...
      <MenuItem onPress={()=>{hideMenu(); 
        ...
        Alert.alert("IMPORTANT NOTICE", "1. Exporting Data will save the app data in CBData.json file in the user defined location. This file will contain all the data of the app in unencrypted format (i.e. readable text).\n\nTo Export Data:\nClick EXPORT DATA > Select Location where to save the file. \n\n2. Importing Data activity will overwrite the installed app's data by the imported data.\n\nTo Import Data:\nClick IMPORT DATA > Select file to import the data from.\n\nNOTE: Do not forget to delete the file CBData.json after importing the data, as it contains app data in readable format.",
        [ {
                text: "Proceed",
                onPress:()=>{
                  let json_data = JSON.parse(fileData);
